    ...
    <div class="header">
        ...
        <div class=tb>
          <?php
            ...
            $t="20";
            $d=$t.$d;
            $query="SELECT * FROM `studentout_req` WHERE `outdate`='$d' AND `status`='accepted' ORDER BY `outtime` ASC";
            $result=mysqli_query($conn,$query);
           ...
           echo "</table>";
            ...
            echo "<div class='norows'>There are no outing confirmations for today</div>";          
          }
        ?>
        </div>
    </body>
